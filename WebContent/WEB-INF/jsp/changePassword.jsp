	...
	<div class="jumbotron top-space">
		<div class="container">
			...
			<form id="resetForm" class="col-md-12 col-lg-5 center" method="POST"
				action="http://www.classroom-hero.com/change"
				style="text-align: center;" style="display:none;">
				<h3>New Password</h3>
				<br>
			<h6 style="text-align: center; color: red;">${mismatch}</h6>
				<div class="form-group">
					<input name="p1" type="password" class="form-control input-lg"
						placeholder="New Password">
				</div>
				
					<div class="form-group">
					<input name="p2" type="password" class="form-control input-lg"
